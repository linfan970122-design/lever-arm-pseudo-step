#!/bin/bash
# M8 replay, one arm. Everything it writes stays under $P2_WORK (default $TMPDIR/p2_m8).
#   $1 ws (ws_stock|ws_gate)  $2 tag  $3 out_dir  $4 bag  $5 start  $6 dur
#   $7 inject(true|false)  $8 gate(true|false)  $9 max_yaw_rate  $10 mahal  $11 port  $12 yaw_pnc  $13 rate
set +u
...
WS=$1; TAG=$2; OUT=$3; BAG=$4; START=$5; DUR=$6; INJ=$7; GATE=$8; MYR=$9; MAHAL=${10}; PORT=${11}; YPNC=${12:-0.06}; RATE=${13:-6.0}
...
roslaunch --port $PORT ${P2_WORK}/m8.launch \
